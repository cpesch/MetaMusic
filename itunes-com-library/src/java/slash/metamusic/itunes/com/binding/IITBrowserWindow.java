...
public class IITBrowserWindow extends Dispatch {

    public static final String componentName = "iTunesLib.IITBrowserWindow";

    public IITBrowserWindow() {
        super(componentName);
    }
     ...
     */
    public IITBrowserWindow(Dispatch d) {
    ...
    public IITBrowserWindow(String compName) {
        super(compName);
    }
    ...
    public boolean getMiniPlayer() {
        return Dispatch.get(this, "MiniPlayer").toBoolean();
    }
     ...
     * @param lastParam an input-parameter of type boolean
     */
    public void setMiniPlayer(boolean lastParam) {
        Dispatch.call(this, "MiniPlayer", new Variant(lastParam));
    }
     ...
     */
    public IITPlaylist getSelectedPlaylist() {
		return new IITPlaylist(Dispatch.get(this, "SelectedPlaylist").toDispatch());
	}
     ...
     */
	public void setSelectedPlaylist(Variant lastParam) {
		Dispatch.call(this, "SelectedPlaylist", lastParam);
	}
