...
public class IITIPodSource extends Dispatch {

    public static final String componentName = "iTunesLib.IITIPodSource";

    public IITIPodSource() {
        super(componentName);
    }
     ...
     */
    public IITIPodSource(Dispatch d) {
    ...
    public IITIPodSource(String compName) {
        super(compName);
    }
    ...
    public double getCapacity() {
        return Dispatch.get(this, "Capacity").toDouble();
    }
    ...
    public double getFreeSpace() {
        return Dispatch.get(this, "FreeSpace").toDouble();
    }
     ...
     * Wrapper for calling the ActiveX-Method with input-parameter(s).
     */
    public void ejectIPod() {
        Dispatch.call(this, "EjectIPod");
    }
	...
	public String getSoftwareVersion() {
		return Dispatch.get(this, "SoftwareVersion").toString();
	}
