...
public class IITEQPresetCollection extends Dispatch {
     ...
     */
    public IITEQPreset getItem(int lastParam) {
        return new IITEQPreset(Dispatch.call(this, "Item", new Variant(lastParam)).toDispatch());
    }
     ...
     * @return the result is of type IITEQPreset
     */
    public IITEQPreset getItemByName(String lastParam) {
        return new IITEQPreset(Dispatch.call(this, "ItemByName", lastParam).toDispatch());
    }
