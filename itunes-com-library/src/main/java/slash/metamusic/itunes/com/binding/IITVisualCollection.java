...
public class IITVisualCollection extends Dispatch {
     ...
     */
    public IITVisual getItem(int lastParam) {
        return new IITVisual(Dispatch.call(this, "Item", new Variant(lastParam)).toDispatch());
    }
     ...
     * @return the result is of type IITVisual
     */
    public IITVisual getItemByName(String lastParam) {
        return new IITVisual(Dispatch.call(this, "ItemByName", lastParam).toDispatch());
    }
