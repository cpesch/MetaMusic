...
public class IITLibraryPlaylist extends Dispatch {

    public static final String componentName = "iTunesLib.IITLibraryPlaylist";

    public IITLibraryPlaylist() {
        super(componentName);
    }
     ...
     */
    public IITLibraryPlaylist(Dispatch d) {
    ...
    public IITLibraryPlaylist(String compName) {
        super(compName);
    }
