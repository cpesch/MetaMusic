...
public class IITWindow extends Dispatch {

    public static final String componentName = "iTunesLib.IITWindow";
    ...
    public IITWindow(String compName) {
        super(compName);
    }
